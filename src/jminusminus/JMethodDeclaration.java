...
class JMethodDeclaration extends JAST implements JMember {
    ...
    public JMethodDeclaration(int line, ArrayList<String> mods, String name,
            Type returnType, ArrayList<JFormalParameter> params, JBlock body)
    ...
    /**
     * Analysis for a method declaration involves (1) creating a new method
     * context (that records the return type; this is used in the analysis of
     * the method body), (2) bumping up the offset (for instance methods), (3)
     * declaring the formal parameters in the method context, and (4) analyzing
     * the method's body.
     * 
     * @param context
