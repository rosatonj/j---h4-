...
enum TokenKind {
    ...
    SHORT("short"), // Added 
    STATIC("static"), 
    STRICTFP("strictfp"), // Added 
    SUPER("super"),
    SWITCH("switch"), // Added 
    SYNCHRONIZED("synchronized"), // Added 
    THIS("this"), 
    THROW("throw"), // Added
    THROWS("throws"), // Added 
    TRANSIENT("transient"), // Added 
    TRY("try"), // Added 
    TRUE("true"), 
    VOID("void"),
    VOLATILE("volatile"), // Added
    WHILE("while"), 
    ...
    DOUBLE_LITERAL("<DOUBLE_LITERAL>"), // Added
